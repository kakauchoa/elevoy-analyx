    ...
    >
      ...
      <div ref={popupRef} className="relative border-t border-white/20 p-3">
        ...
        {!isAdmin && !collapsed && (
          <Link
            href="/planos"
            className="flex items-center gap-2 mx-0 mb-2 px-3 py-2 rounded-lg bg-white/10 hover:bg-white/20 transition-colors"
          >
            <svg className="w-4 h-4 text-yellow-300 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3l14 9-14 9V3z" />
            </svg>
            <span className="text-xs font-medium text-white">Ver planos / Upgrade</span>
          </Link>
        )}
